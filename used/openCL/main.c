...
int main(void)
{
	...
	cl_double3* r = (cl_double3*)malloc(sizeof(cl_double3) * beadNumber);
	InitializeConfiguration(r);

	/* 2. Initialize parameters */
	cl_double3* rs = (cl_double3*)malloc(sizeof(cl_double3) * beadNumber);
	memcpy(rs, r, sizeof(cl_double3) * beadNumber);
	long seed = 3;
